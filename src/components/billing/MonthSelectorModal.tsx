        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <select
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-neutral-800 focus:border-transparent"
            >
            ...
            {monthNames.map((monthName, index) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-col items-center justify-center p-4 border-2 border-gray-200 rounded-lg hover:border-neutral-800 hover:bg-neutral-50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <FileText
                    size={28}
