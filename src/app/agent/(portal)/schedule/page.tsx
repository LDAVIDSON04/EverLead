...
export default function SchedulePage() {
  ...
  return (
    <div className="w-full h-screen flex flex-col bg-white" style={{ padding: '32px', paddingTop: '8px', overflow: 'visible' }}>
      {/* Header */}
      <div className="flex items-center justify-between mb-8" style={{ marginTop: '0', paddingTop: '0' }}>
        <div className="flex items-center gap-4">
          <h1 className="text-3xl font-semibold" style={{ marginTop: '-16px', paddingTop: '16px' }}>{formatDate(weekDates[0])}</h1>
          <button 
            onClick={goToToday}
