      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="px-4 py-2 bg-neutral-800 text-white rounded-lg hover:bg-neutral-900 disabled:opacity-50"
          >
...
export default function AvailabilityPage() {
  ...
  // Daily availability state - start from today
  const [currentWeekStart, setCurrentWeekStart] = useState<Date>(() => {
    const today = new Date();
    // Set to start of today (midnight) to avoid timezone issues
  ...
  const getWeekDates = () => {
    const dates: Date[] = [];
    // Start from today, show today + 6 days ahead (7 days total)
    for (let i = 0; i < 7; i++) {
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${existing
                        ? "border-neutral-500 bg-gradient-to-br from-neutral-50 to-neutral-50 shadow-md"
                        : "border-gray-200 bg-white hover:border-neutral-300 hover:bg-neutral-50/30 shadow-sm"
                      }
                      ${isToday 
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start mb-3">
                      <div className={`
                        ...
                        ${existing ? "text-neutral-700" : "text-gray-500"}
                      ...
                      <div className={`
                        text-2xl font-bold
                        ${isToday ? "text-blue-600" : existing ? "text-neutral-900" : "text-gray-900"}
                      `}>
                        {dayNum}
                      </div>
                      ...
                      {existing ? (
                        <div className="space-y-1.5">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-xs font-semibold text-neutral-700">Available</span>
                          </div>
                    ...
                    {!existing && (
                      <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-neutral-500/0 to-neutral-500/0 group-hover:from-neutral-500/5 group-hover:to-neutral-500/5 transition-all duration-200 pointer-events-none"></div>
                    )}
                  </button>
                );
              })}
