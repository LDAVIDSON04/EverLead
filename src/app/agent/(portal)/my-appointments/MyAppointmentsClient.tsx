          ...
          {canUpdateStatus && (
            <div className="border-t border-gray-200 pt-4 flex gap-3">
              <button
                ...
                className="rounded-lg bg-green-800 px-4 py-2 text-sm font-medium text-white hover:bg-green-900 disabled:cursor-not-allowed disabled:opacity-60 transition-colors"
              >
