  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Profile Bio</h2>
          <p className="text-sm text-gray-600">Fill out structured information to generate your professional bio</p>
        </div>
      </div>
