      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="hidden lg:flex items-center justify-center p-12 bg-gradient-to-br from-neutral-50 to-neutral-50">
                  ...
                  {forgotPasswordSent ? (
                    <div className="space-y-4">
                      ...
                      <button
                        ...
                        className="bg-neutral-700 hover:bg-neutral-800 text-white px-14 py-3 rounded-lg transition-all shadow-md hover:shadow-lg"
                      >
                        Back to login
                      </button>
                    </div>
                    ...
                    <>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-8 pr-4 py-3 bg-transparent border-b-2 border-zinc-300 text-black focus:outline-none focus:border-neutral-700 transition-colors placeholder:text-zinc-400"
                          placeholder="Email"
                          required
                        />
                      </div>
                      ...
                      <div className="pt-6 flex gap-2">
                        <button
                          type="submit"
                          disabled={submitting}
                          className="bg-neutral-700 hover:bg-neutral-800 text-white px-14 py-3 rounded-lg transition-all shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                ...
                <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8 relative z-20">
                      ...
                      <div className="space-y-3 border-t border-zinc-200 pt-4">
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            className="flex-1 px-3 py-2 border-b-2 border-zinc-300 bg-transparent text-black focus:outline-none focus:border-neutral-700 placeholder:text-zinc-400"
                          />
                          <select
                            value={newProvince}
                            onChange={(e) => setNewProvince(e.target.value)}
                            className="w-24 px-3 py-2 border-b-2 border-zinc-300 bg-transparent text-black focus:outline-none focus:border-neutral-700"
                          >
                          ...
                          <button
                            ...
                            className="bg-neutral-700 hover:bg-neutral-800 text-white px-4 py-2 rounded-lg transition-all"
                          >
                            Add
                          </button>
                        </div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-12 py-3 bg-transparent border-b-2 border-zinc-300 text-black focus:outline-none focus:border-neutral-700 transition-colors placeholder:text-zinc-400"
                  ...
                  <div className="pt-6 relative z-20">
                    <button
                      ...
                      className="bg-neutral-700 hover:bg-neutral-800 text-white px-14 py-3 rounded-lg transition-all shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed relative z-20"
                ...
                {mode === "login" && !showForgotPassword && (
                  <div className="space-y-2">
                    <p className="text-zinc-700 text-center">
                      ...
                      <Link
                        href="/create-account"
                        className="text-neutral-700 hover:text-neutral-800 transition-colors underline"
                      >
                        create account now
                      </Link>
                    </p>
            ...
            <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
              <div className="text-center">
                ...
                <button
                  ...
                  className="w-full bg-neutral-700 hover:bg-neutral-800 text-white px-4 py-2 rounded-lg transition-all shadow-md"
                >
                  Close
                </button>
              </div>
