      ...
      <div className="relative bg-[#FAF9F6] pb-12 px-4 min-h-[calc(100vh-80px)] flex items-start md:pt-32 pt-0 md:pb-12 -mt-2 md:mt-0" style={{ overflow: 'visible' }}>
        ...
        <div className="max-w-7xl mx-auto relative z-20 w-full md:mt-0 mt-1 overflow-visible">
          ...
          <div className="max-w-4xl">
            ...
            <form onSubmit={handleSearch} className="bg-white rounded-2xl p-3 shadow-lg border-2 border-[#1A1A1A] relative z-30 md:mb-8 mb-4 flex-shrink-0">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-[#FAF9F6] rounded-3xl p-6 border-2 border-[#1A1A1A] relative overflow-visible group flex flex-col transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-2xl hover:shadow-black/10 hover:-translate-y-1 max-md:hover:scale-100 max-md:hover:translate-y-0">
              ...
              {/* Browse icon: plain img so transparency is preserved (no Next.js optimization) */}
            ...
            <div className="bg-[#FAF9F6] rounded-3xl p-6 border-2 border-[#1A1A1A] relative overflow-visible group flex flex-col transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-2xl hover:shadow-black/10 hover:-translate-y-1 max-md:hover:scale-100 max-md:hover:translate-y-0">
              ...
              <Image
                ...
                width={224}
                height={224}
                className="w-full h-full object-contain max-md:pointer-events-none"
                style={{
                  filter: "brightness(1.1) contrast(1.05)",
                  mixBlendMode: "multiply",
