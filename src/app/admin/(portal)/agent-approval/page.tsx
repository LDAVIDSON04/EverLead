                                            ...
                                            <div class="bg-white rounded-lg p-6 max-w-2xl max-h-[80vh] overflow-auto">
                                              ...
                                              <div class="space-y-4">
                                                ...
                                                <div class="flex gap-3 pt-4 border-t">
                                                  <a href="${docUrl}" target="_blank" rel="noopener noreferrer" class="px-4 py-2 bg-emerald-700 text-white rounded hover:bg-emerald-800 text-sm inline-flex items-center gap-2">
