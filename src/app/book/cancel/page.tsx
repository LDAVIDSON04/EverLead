              ...
              {appointmentData.office_location && officeLocations.length > 1 && (
                <div className="mb-6">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-lg hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-neutral-600 focus:border-neutral-600 transition-all text-base"
                  >
                ...
                <div className="space-y-6">
                  {(() => {
                    ...
                    .map((day, dayIdx) => {
                      ...
                      return (
                        <div key={dayIdx} className={`border-b border-gray-200 pb-6 last:border-b-0 ${isSelected ? 'bg-neutral-50 -mx-6 px-6 pt-4 rounded-lg' : ''}`}>
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-neutral-600 text-white rounded-lg hover:bg-neutral-700 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
