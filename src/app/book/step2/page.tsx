    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/search" className="text-neutral-800 hover:underline">
            Return to search
          </Link>
        </div>
      </div>
      ...
      <main className="max-w-[800px] mx-auto px-4 py-8">
        ...
        <div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-neutral-800 ${
          ...
          <button
            ...
            className="w-full bg-neutral-800 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:bg-neutral-900 transition-colors"
          >
            Continue
          </button>
        </div>
