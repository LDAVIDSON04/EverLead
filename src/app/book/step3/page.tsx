      ...
      <main className="max-w-[800px] mx-auto px-4 py-8">
        ...
        <div>
          ...
          <button
            onClick={handleBook}
            disabled={isBooking}
            className="w-full bg-neutral-800 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:bg-neutral-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
