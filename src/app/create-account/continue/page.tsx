      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl mx-auto p-8 md:p-12">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <div className={`flex items-center gap-2 ${currentStep >= 1 ? 'text-neutral-700' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 1 ? 'bg-neutral-700 text-white' : 'bg-gray-200'}`}>
                {currentStep > 1 ? <Check className="w-5 h-5" /> : '1'}
              </div>
              <span className="font-medium">Basic Info</span>
            </div>
            <div className={`flex-1 h-1 mx-4 ${currentStep >= 2 ? 'bg-neutral-700' : 'bg-gray-200'}`} />
            <div className={`flex items-center gap-2 ${currentStep >= 2 ? 'text-neutral-700' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 2 ? 'bg-neutral-700 text-white' : 'bg-gray-200'}`}>
                {currentStep > 2 ? <Check className="w-5 h-5" /> : '2'}
              </div>
              <span className="font-medium">Business Info</span>
            </div>
            <div className={`flex-1 h-1 mx-4 ${currentStep >= 3 ? 'bg-neutral-700' : 'bg-gray-200'}`} />
            <div className={`flex items-center gap-2 ${currentStep >= 3 ? 'text-neutral-700' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 3 ? 'bg-neutral-700 text-white' : 'bg-gray-200'}`}>
                3
              </div>
        ...
        <form onSubmit={currentStep === 3 ? handleSubmit : (e) => { e.preventDefault(); handleNext(); }}>
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:border-neutral-700 outline-none transition-colors"
                  required
                />
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Email *"
                  className={`w-full pl-10 pr-4 py-3 border-2 rounded-lg focus:border-neutral-700 outline-none transition-colors ${
              ...
              <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border-2 border-gray-300 rounded-lg focus:border-neutral-700 outline-none transition-colors"
                  required
                />
                  <button
                    type="button"
              ...
              <div className="grid grid-cols-3 gap-4">
                  ...
                  onChange={(e) => setBasicInfo({ ...basicInfo, city: e.target.value })}
                    placeholder="City *"
                  className="px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-neutral-700 outline-none transition-colors"
                    required
                  />
                  <select
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-neutral-700 outline-none transition-colors"
                  required
            />
          </div>
                ...
                <div className="flex gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 text-neutral-800 border-gray-300 focus:ring-neutral-800"
                    />
                  ...
                  <div className="mb-4 p-4 border-2 border-gray-300 rounded-lg bg-gray-50">
                    ...
                    <div className="space-y-3">
                      <input
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-neutral-700 outline-none"
                      />
                      <input
                        type="text"
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <input
                          ...
                          placeholder="City *"
                          className="px-4 py-2 border border-gray-300 rounded-lg focus:border-neutral-700 outline-none"
                        />
                        <select
                    ...
                    <button
                      type="button"
                          ...
                          className="px-4 py-2 bg-neutral-700 text-white rounded-lg hover:bg-neutral-800"
                        >
                          Add
                        </button>
                        <button
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  rows={3}
                  maxLength={200}
                      className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-neutral-700 outline-none transition-colors resize-none"
                  required
                    />
            ...
            <div className="mt-6 p-4 border-2 border-gray-300 rounded-lg bg-gray-50">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-1 w-5 h-5 text-neutral-800 border-gray-300 rounded focus:ring-neutral-800"
                  required
                />
          ...
          <div className="flex justify-between items-center mt-8 pt-6 border-t">
            ...
            {currentStep < 3 ? (
              <button
                type="submit"
                className="flex items-center gap-2 px-6 py-3 bg-neutral-700 text-white rounded-lg hover:bg-neutral-800 transition-colors"
              >
                Next
          ...
          <button
            type="submit"
            disabled={submitting}
                className="px-8 py-3 bg-neutral-700 text-white rounded-lg hover:bg-neutral-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-semibold"
          >
          ...
          <p className="text-center text-gray-600 text-sm mt-6">
            ...
            <Link href="/agent" className="text-neutral-700 hover:underline">
              log in
            </Link>
          </p>
        </form>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="px-8 bg-neutral-700 hover:bg-neutral-800 text-white py-2 rounded-lg transition-colors"
              >
                Return Home
              </button>
            </div>
