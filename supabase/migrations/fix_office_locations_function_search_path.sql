-- Fix search_path security issue for update_office_locations_updated_at function
...
COMMENT ON FUNCTION public.update_office_locations_updated_at() IS 'Trigger function to update updated_at timestamp. Uses fixed search_path for security.';
